    ...
    <div className="w-full min-h-screen bg-[#090A0F] flex justify-center text-[#F3F4F6]">
      <div className="w-full max-w-[390px] min-h-screen flex flex-col relative pb-36 px-1">
        ...
        <PageTransition className="flex-1 flex flex-col">
          <header className="pt-5 pb-3 px-1 flex items-center gap-3">
            <button
              type="button"
              onClick={onBack}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between px-1">
                ...
                <span className="text-[11px] text-[#8A92A0]">
                  {isCharcoal ? 'Dark Charcoal Style' : 'Vibrant Neon Style'}
                </span>
              </div>
              ...
              >
                <div className="flex items-center justify-between relative z-10">
                  ...
                  <div
                    className={`px-2.5 py-1 rounded-full text-[11px] font-bold ${
                      isCharcoal
                        ? 'bg-[#1B1E26] border border-white/[0.04] text-white'
                        : 'bg-black/15 text-[#090A0F]'
                    }`}
                  >
                    Target: {target}%
                  </div>
                ...
                <div className="flex items-end justify-between relative z-10 my-4">
                  <div>
                    <div className={`text-3xl font-black tracking-tight leading-none ${isCharcoal ? 'text-white' : 'text-[#090A0F]'}`}>
                      85%
                    </div>
                    <p
                      className={`text-xs font-semibold mt-1 ${
                        isCharcoal ? 'text-[#8A92A0]' : 'text-[#090A0F]/80'
                      }`}
                    >
                ...
                <div
                  className={`w-full h-2.5 rounded-full overflow-hidden relative z-10 ${
                    isCharcoal ? 'bg-[#1B1E26] border border-white/[0.04]' : 'bg-black/20'
                  }`}
                >
                  <div
